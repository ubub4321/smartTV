...
enyo.kind({
                                      ...
                                      {kind: 'enyo.Scroller', classes : "enyo-fit",
                                         components: [{      
                                        	 components : [{kind:"FittableRows",							
		            	            			  components :[{name:"wish_8",kind:"moon.Image",style:"margin-left:620px;",src:"assets/play/towishlist.png",classes:"gtwish",ontap:"imageClick",onmouseout:"Selectout_wish",onmouseover:"Selecton_wish"},
   ...
   {
         this.$.wish_8.setSrc("assets/play/towishlist_modify.png");   
   },
   Selectout_wish: function(inSender, inEvent)
   {
         this.$.wish_8.setSrc("assets/play/towishlist.png");      
   },
      ...
      search: function(inSearchText, inPage) {
       // username:  decodeURIComponent($('#username').val());
         ...
         var params = {                        //http://meeneeon.ddns.net:8080/wishList.php
            q: 'select * from html where url = "http://meeneeon.ddns.net/star6.php"'
         };
         var req;
