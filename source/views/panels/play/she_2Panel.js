...
enyo.kind({
			            	              ...
			            	              {kind: 'enyo.Scroller', classes : "enyo-fit",
			            	            	  components: [{		
			            	            		  components : [{kind:"FittableRows",							
			            	            			  components :[{name:"wish_5",kind:"moon.Image",style:"margin-left:620px;",src:"assets/play/towishlist.png",classes:"gtwish",ontap:"imageClick",onmouseout:"Selectout_wish",onmouseover:"Selecton_wish"},
	...
	Selecton_wish: function(inSender, inEvent)
	   {
	         this.$.wish_5.setSrc("assets/play/towishlist_modify.png");   
	   },
	   Selectout_wish: function(inSender, inEvent)
	   {
	         this.$.wish_5.setSrc("assets/play/towishlist.png");      
	   },
