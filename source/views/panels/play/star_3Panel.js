...
enyo.kind({
                                      ...
                                      {kind: 'enyo.Scroller', classes : "enyo-fit",
                                         components: [{      
                                        	 components : [{kind:"FittableRows",							
		            	            			  components :[{name:"wish_9",kind:"moon.Image",style:"margin-left:620px;",src:"assets/play/towishlist.png",classes:"gtwish",ontap:"imageClick",onmouseout:"Selectout_wish",onmouseover:"Selecton_wish"},
                                                  ...
                                                  components : [
                                                                {
                                                                   ...
                                                                   components: [
                                                                                {kind: 'FittableRows', classes: 'fittable-sample-column', style : "width : 130px !important;",
                                                                                   ...
                                                                                   {
                                                                                      name : "reresult1_2",
                                                                                      classes : "table",                                                                                      style : "margin-left:300px;",
                                                                                      style : "margin-left:300px;",
   ...
   {
         this.$.wish_9.setSrc("assets/play/towishlist_modify.png");   
   },
   Selectout_wish: function(inSender, inEvent)
   {
         this.$.wish_9.setSrc("assets/play/towishlist.png");      
   },
