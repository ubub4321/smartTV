enyo.kind({
          ...
          components: [
            ...
            {kind: "FittableColumns", style: "padding-left : 105px;",// 왼쪽 띄워진 부분부터 column으로 묶어줌
               ...
               components: [
                            ...
                            {kind : "moon.Image",name : "img4",classes:"Photos",ontap : "Stfashion", onmouseout:"Selectout4",onmouseover:"Selecton4"}, // 사진 3


                           {kind : "moon.Image",name : "img5",classes:"bottomPhoto1",ontap : "Stfashion", onmouseout:"Selectout5",onmouseover:"Selecton5"},
                            {kind : "moon.Image",name : "img6",classes:"bottomPhoto2",ontap : "Stfashion", onmouseout:"Selectout6",onmouseover:"Selecton6"},
                  ...
                  components: [
                   {name : "popup",style:"width : 680px; height :350px;",  //style:"background-color: black;",
                      ...
                      {style:"margin-top:10px;",//style:"background-color: black;",
                         components :[
                      {kind : "moon.Image",name : "img7", classes:"Photos",ontap : "Stfashion", onmouseout:"Selectout7",onmouseover:"Selecton7"},
   ...
   fashionnew :  function()
      ...
      Selecton1: function(inSender, inEvent)
	   {
	      this.$.img1.setSrc("assets/1_modify.jpg");   
	   },
	 ...
	 Selecton2: function(inSender, inEvent)
	   {
		  this.$.img2.setSrc("assets/2_modify.jpg");   
	   },
	 ...
	 Selecton3: function(inSender, inEvent)
	   {
	      this.$.img3.setSrc("assets/3_modify.jpg");   
	   },
	 ...
	 Selecton4: function(inSender, inEvent)
	   {
	      this.$.img4.setSrc("assets/4_modify.jpg");   
	   },
	 ...
	 Selecton5: function(inSender, inEvent)
	   {
	      this.$.img5.setSrc("assets/5_modify.jpg");   
	   },
	 ...
	 Selecton6: function(inSender, inEvent)
	   {
	      this.$.img6.setSrc("assets/7_modify.jpg");   
	   },
	 ...
	 Selecton7: function(inSender, inEvent)
	   {
	      this.$.img7.setSrc("assets/6_modify.jpg");   
	   },
	 Selectout7: function(inSender, inEvent)
	   {
	      this.$.img7.setSrc("assets/6.jpg");      
	   },
